...
(function (global, factory) {
	...
	class Pano extends t3d.Mesh {
		constructor(options = {}) {
			const geometry = new t3d.SphereGeometry(options.radius || 10, 60, 40);
			const material = new t3d.ShaderMaterial(PanoShader);
	...
	class PanoCameraControls {
		constructor(object, domElement) {
			...
			const lastQuaternion = new t3d.Quaternion();
			const EPS = 0.000001;
			let lastFov = 0;
			let scale = 1;
			const rotateStart = new t3d.Vector2();
			const rotateEnd = new t3d.Vector2();
			const rotateAccum = new t3d.Vector2();
			const rotateDelta = new t3d.Vector2();
			const rotateVector = new t3d.Vector2();
			const dollyStart = new t3d.Vector2();
			const dollyEnd = new t3d.Vector2();
			const dollyDelta = new t3d.Vector2();
			const STATE = {
				NONE: 0,
				MOUSE: 1,
				TOUCH_ROTATE: 2,
